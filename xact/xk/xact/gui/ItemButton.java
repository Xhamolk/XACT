...
public class ItemButton extends GuiButton {
	...
	public ItemButton( int id, ItemStack item, int posX, int posY, boolean isMainNode) {
		super( id, posX, posY, isMainNode ? 26 : 22, isMainNode ? 26 : 22, "");
